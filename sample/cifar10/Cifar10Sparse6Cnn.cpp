...
void Cifar10Sparse6Cnn(int epoch_size, int mini_batch_size, int max_run_size, bool binary_mode, bool file_read)
{
  ...
  // load cifar-10 data
    ...
    auto layer_cnv0_sl1 = bb::StochasticLutBn<6>::Create(192);
    auto layer_cnv0_sl2 = bb::StochasticLutBn<6>::Create(32);
    auto layer_cnv1_sl0 = bb::StochasticLutBn<6>::Create(256);
    auto layer_cnv1_sl1 = bb::StochasticLutBn<6>::Create(192);
    auto layer_cnv1_sl2 = bb::StochasticLutBn<6>::Create(32);
    auto layer_cnv2_sl0 = bb::StochasticLutBn<6>::Create(512);
    auto layer_cnv2_sl1 = bb::StochasticLutBn<6>::Create(384);
    auto layer_cnv2_sl2 = bb::StochasticLutBn<6>::Create(64);
    auto layer_cnv3_sl0 = bb::StochasticLutBn<6>::Create(512);
    auto layer_cnv3_sl1 = bb::StochasticLutBn<6>::Create(384);
