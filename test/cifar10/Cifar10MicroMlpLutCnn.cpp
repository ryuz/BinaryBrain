                                    ...
                                    int frame_mux_size, int lut_frame_mux_size, bool binary_mode, bool file_read)
{
  ...
  // load cifar-10 data
    ...
    // create network
    auto layer_cnv0_mm0 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(384);
    auto layer_cnv0_mm1 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(64);
    
    auto layer_cnv1_mm0 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(1024);
    auto layer_cnv1_mm1 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(384);
    auto layer_cnv1_mm2 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(64);
    
    auto layer_cnv2_mm0 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(2048);
    auto layer_cnv2_mm1 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(768);
    auto layer_cnv2_mm2 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(128);
    
    auto layer_cnv3_mm0 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(2048);
    auto layer_cnv3_mm1 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(768);
    auto layer_cnv3_mm2 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(128);

    auto layer_mm4      = bb::MicroMlp<6, 16, bb::Bit, float>::Create(4096);
    auto layer_mm5      = bb::MicroMlp<6, 16, bb::Bit, float>::Create(1860);
...
//      main_net->Add(bb::RealToBinary<bb::Bit>::Create(frame_mux_size));
...
void Cifar10MicroMlpLutCnn(int epoch_size, int mini_batch_size, int max_run_size,
                                    int frame_mux_size, int lut_frame_mux_size, bool binary_mode, bool file_read)
{
    std::string net_name = "Cifar10MiroMlpLutCnn_bit";
  ...
  // load cifar-10 data
    ...
    // create network
    auto layer_cnv0_mm0 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(256);
    auto layer_cnv0_mm1 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(192);
    auto layer_cnv0_mm2 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(32);
    auto layer_cnv1_mm0 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(256);
    auto layer_cnv1_mm1 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(192);
    auto layer_cnv1_mm2 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(32);
    auto layer_cnv2_mm0 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(512);
    auto layer_cnv2_mm1 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(384);
    auto layer_cnv2_mm2 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(64);
    auto layer_cnv3_mm0 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(512);
    auto layer_cnv3_mm1 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(384);
    auto layer_cnv3_mm2 = bb::MicroMlp<6, 16, bb::Bit, float>::Create(64);
    auto layer_mm4      = bb::MicroMlp<6, 16, bb::Bit, float>::Create(1024);
    auto layer_mm5      = bb::MicroMlp<6, 16, bb::Bit, float>::Create(420);
    auto layer_mm6      = bb::MicroMlp<6, 16, bb::Bit, float>::Create(70);
