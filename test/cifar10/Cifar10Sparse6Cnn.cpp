...
void Cifar10Sparse6Cnn(int epoch_size, int mini_batch_size, int max_run_size, bool binary_mode, bool file_read)
{
  ...
  // load cifar-10 data
    ...
    {
        auto cnv0_sub = bb::Sequential::Create();
        cnv0_sub->Add(bb::SparseLutN<6>::Create(256));
        cnv0_sub->Add(bb::SparseLutN<6>::Create(256));
        cnv0_sub->Add(bb::SparseLutN<6>::Create(64));

        auto cnv1_sub = bb::Sequential::Create();
        cnv1_sub->Add(bb::SparseLutN<6>::Create(256));
        cnv1_sub->Add(bb::SparseLutN<6>::Create(256));
        cnv1_sub->Add(bb::SparseLutN<6>::Create(256));
        cnv1_sub->Add(bb::SparseLutN<6>::Create(64));

        auto cnv2_sub = bb::Sequential::Create();
        cnv2_sub->Add(bb::SparseLutN<6>::Create(256));
        cnv2_sub->Add(bb::SparseLutN<6>::Create(256));
        cnv2_sub->Add(bb::SparseLutN<6>::Create(256));
        cnv2_sub->Add(bb::SparseLutN<6>::Create(64));
