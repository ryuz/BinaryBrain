...
void MnistDenseCnn_(int epoch_size, int mini_batch_size, int train_modulation_size, int test_modulation_size, bool binary_mode, bool file_read)
{
...

    {
        ...
        main_net->Add(bb::LoweringConvolution<T>::Create(cnv1_net, 3, 3));   // Conv3x3 x 32 [24x24]
        main_net->Add(bb::MaxPooling<T>::Create(2, 2));                      //              [12x12]
        main_net->Add(bb::LoweringConvolution<T>::Create(cnv2_net, 3, 3));   // Conv3x3 x 64 [10x10]
        main_net->Add(bb::LoweringConvolution<T>::Create(cnv3_net, 3, 3));   // Conv3x3 x 64 [8x8]
