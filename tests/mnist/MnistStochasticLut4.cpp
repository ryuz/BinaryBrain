...
void MnistStochasticLut4(int epoch_size, size_t mini_batch_size, bool binary_mode)
{
  std::string net_name = "MnistStochasticLut4";

  // load MNIST data
#ifdef _DEBUG
    auto td = bb::LoadMnist<>::Load(1024, 1024);
#else
