...
TEST(ConvolutionIm2ColTest, testConvolutionIm2Col_xy)
{
    ...
    bb::FrameBuffer buf_x(16, {3, 28, 28}, BB_TYPE_FP32);
//  cnvim2col->SetInputShape({3, 28, 28});
...
//  buf_y.Reshape({ 2, 2, 3 });
    ...
    EXPECT_EQ(1,    buf_y.GetFP32(0, { 0, 0, 1 }));
    EXPECT_EQ(2,    buf_y.GetFP32(0, { 0, 0, 2 }));
    EXPECT_EQ(10,   buf_y.GetFP32(0, { 0, 1, 0 }));
    EXPECT_EQ(11,   buf_y.GetFP32(0, { 0, 1, 1 }));
    EXPECT_EQ(12,   buf_y.GetFP32(0, { 0, 1, 2 }));
    EXPECT_EQ(100,  buf_y.GetFP32(0, { 1, 0, 0 }));
    EXPECT_EQ(101,  buf_y.GetFP32(0, { 1, 0, 1 }));
    EXPECT_EQ(102,  buf_y.GetFP32(0, { 1, 0, 2 }));
    EXPECT_EQ(110,  buf_y.GetFP32(0, { 1, 1, 0 }));
    EXPECT_EQ(111,  buf_y.GetFP32(0, { 1, 1, 1 }));
    EXPECT_EQ(112,  buf_y.GetFP32(0, { 1, 1, 2 }));

    EXPECT_EQ(1,    buf_y.GetFP32(1, { 0, 0, 0 }));
    EXPECT_EQ(2,    buf_y.GetFP32(1, { 0, 0, 1 }));
    EXPECT_EQ(3,    buf_y.GetFP32(1, { 0, 0, 2 }));
    EXPECT_EQ(11,   buf_y.GetFP32(1, { 0, 1, 0 }));
    EXPECT_EQ(12,   buf_y.GetFP32(1, { 0, 1, 1 }));
    EXPECT_EQ(13,   buf_y.GetFP32(1, { 0, 1, 2 }));
    EXPECT_EQ(101,  buf_y.GetFP32(1, { 1, 0, 0 }));
    EXPECT_EQ(102,  buf_y.GetFP32(1, { 1, 0, 1 }));
    EXPECT_EQ(103,  buf_y.GetFP32(1, { 1, 0, 2 }));
    EXPECT_EQ(111,  buf_y.GetFP32(1, { 1, 1, 0 }));
    EXPECT_EQ(112,  buf_y.GetFP32(1, { 1, 1, 1 }));
    EXPECT_EQ(113,  buf_y.GetFP32(1, { 1, 1, 2 }));

    EXPECT_EQ(10,   buf_y.GetFP32(2, { 0, 0, 0 }));
    EXPECT_EQ(11,   buf_y.GetFP32(2, { 0, 0, 1 }));
    EXPECT_EQ(12,   buf_y.GetFP32(2, { 0, 0, 2 }));
    EXPECT_EQ(20,   buf_y.GetFP32(2, { 0, 1, 0 }));
    EXPECT_EQ(21,   buf_y.GetFP32(2, { 0, 1, 1 }));
    EXPECT_EQ(22,   buf_y.GetFP32(2, { 0, 1, 2 }));
    EXPECT_EQ(110,  buf_y.GetFP32(2, { 1, 0, 0 }));
    EXPECT_EQ(111,  buf_y.GetFP32(2, { 1, 0, 1 }));
    EXPECT_EQ(112,  buf_y.GetFP32(2, { 1, 0, 2 }));
    EXPECT_EQ(120,  buf_y.GetFP32(2, { 1, 1, 0 }));
    EXPECT_EQ(121,  buf_y.GetFP32(2, { 1, 1, 1 }));
    EXPECT_EQ(122,  buf_y.GetFP32(2, { 1, 1, 2 }));

    EXPECT_EQ(11,   buf_y.GetFP32(3, { 0, 0, 0 }));
    EXPECT_EQ(12,   buf_y.GetFP32(3, { 0, 0, 1 }));
    EXPECT_EQ(13,   buf_y.GetFP32(3, { 0, 0, 2 }));
    EXPECT_EQ(21,   buf_y.GetFP32(3, { 0, 1, 0 }));
    EXPECT_EQ(22,   buf_y.GetFP32(3, { 0, 1, 1 }));
    EXPECT_EQ(23,   buf_y.GetFP32(3, { 0, 1, 2 }));
    EXPECT_EQ(111,  buf_y.GetFP32(3, { 1, 0, 0 }));
    EXPECT_EQ(112,  buf_y.GetFP32(3, { 1, 0, 1 }));
    EXPECT_EQ(113,  buf_y.GetFP32(3, { 1, 0, 2 }));
    EXPECT_EQ(121,  buf_y.GetFP32(3, { 1, 1, 0 }));
    EXPECT_EQ(122,  buf_y.GetFP32(3, { 1, 1, 1 }));
    EXPECT_EQ(123,  buf_y.GetFP32(3, { 1, 1, 2 }));

    EXPECT_EQ(1010, buf_y.GetFP32(6, { 0, 0, 0 }));
    EXPECT_EQ(1011, buf_y.GetFP32(6, { 0, 0, 1 }));
    EXPECT_EQ(1012, buf_y.GetFP32(6, { 0, 0, 2 }));
    EXPECT_EQ(1020, buf_y.GetFP32(6, { 0, 1, 0 }));
    EXPECT_EQ(1021, buf_y.GetFP32(6, { 0, 1, 1 }));
    EXPECT_EQ(1022, buf_y.GetFP32(6, { 0, 1, 2 }));
    EXPECT_EQ(1110, buf_y.GetFP32(6, { 1, 0, 0 }));
    EXPECT_EQ(1111, buf_y.GetFP32(6, { 1, 0, 1 }));
    EXPECT_EQ(1112, buf_y.GetFP32(6, { 1, 0, 2 }));
    EXPECT_EQ(1120, buf_y.GetFP32(6, { 1, 1, 0 }));
    EXPECT_EQ(1121, buf_y.GetFP32(6, { 1, 1, 1 }));
    EXPECT_EQ(1122, buf_y.GetFP32(6, { 1, 1, 2 }));

    EXPECT_EQ(1011, buf_y.GetFP32(7, { 0, 0, 0 }));
    EXPECT_EQ(1012, buf_y.GetFP32(7, { 0, 0, 1 }));
    EXPECT_EQ(1013, buf_y.GetFP32(7, { 0, 0, 2 }));
    EXPECT_EQ(1021, buf_y.GetFP32(7, { 0, 1, 0 }));
    EXPECT_EQ(1022, buf_y.GetFP32(7, { 0, 1, 1 }));
    EXPECT_EQ(1023, buf_y.GetFP32(7, { 0, 1, 2 }));
    EXPECT_EQ(1111, buf_y.GetFP32(7, { 1, 0, 0 }));
    EXPECT_EQ(1112, buf_y.GetFP32(7, { 1, 0, 1 }));
    EXPECT_EQ(1113, buf_y.GetFP32(7, { 1, 0, 2 }));
    EXPECT_EQ(1121, buf_y.GetFP32(7, { 1, 1, 0 }));
    EXPECT_EQ(1122, buf_y.GetFP32(7, { 1, 1, 1 }));
    EXPECT_EQ(1123, buf_y.GetFP32(7, { 1, 1, 2 }));;

    // backward
    bb::FrameBuffer buf_dy(8, { 2, 2, 3 }, BB_TYPE_FP32);
        ...
        for (bb::index_t c = 0; c < 2; ++c) {
            for (bb::index_t y = 0; y < 2; ++y) {
                for (bb::index_t x = 0; x < 3; ++x) {
                    ...
                    buf_dy.SetFP32(f, { c, y, x }, dy_data[f][c][y][x]);
                }
            }
        }
    }
...
TEST(ConvolutionIm2ColTest, testConvolutionIm2Col_float)
{
    ...
    bb::FrameBuffer buf_x(1, {1, 3, 3}, BB_TYPE_FP32);
    ...
    buf_x.SetFP32(0, { 0, 0, 1}, 1);
    buf_x.SetFP32(0, { 0, 0, 2}, 1);
    buf_x.SetFP32(0, { 0, 1, 0}, 1);
    buf_x.SetFP32(0, { 0, 1, 1}, 0);
    buf_x.SetFP32(0, { 0, 1, 2}, 1);
    buf_x.SetFP32(0, { 0, 2, 0}, 0);
    buf_x.SetFP32(0, { 0, 2, 1}, 1);
    buf_x.SetFP32(0, { 0, 2, 2}, 0);
    ...
    EXPECT_EQ(0, buf_y.GetFP32(0, { 0, 1, 1 }));
    EXPECT_EQ(1, buf_y.GetFP32(1, { 0, 0, 0 }));
    EXPECT_EQ(1, buf_y.GetFP32(1, { 0, 0, 1 }));
    EXPECT_EQ(0, buf_y.GetFP32(1, { 0, 1, 0 }));
    EXPECT_EQ(1, buf_y.GetFP32(1, { 0, 1, 1 }));
    EXPECT_EQ(1, buf_y.GetFP32(2, { 0, 0, 0 }));
    EXPECT_EQ(0, buf_y.GetFP32(2, { 0, 0, 1 }));
    EXPECT_EQ(0, buf_y.GetFP32(2, { 0, 1, 0 }));
    EXPECT_EQ(1, buf_y.GetFP32(2, { 0, 1, 1 }));
    EXPECT_EQ(0, buf_y.GetFP32(3, { 0, 0, 0 }));
    EXPECT_EQ(1, buf_y.GetFP32(3, { 0, 0, 1 }));
    EXPECT_EQ(1, buf_y.GetFP32(3, { 0, 1, 0 }));
    EXPECT_EQ(0, buf_y.GetFP32(3, { 0, 1, 1 }));
}
...
TEST(ConvolutionIm2ColTest, testConvolutionIm2Col_bit)
{
    ...
    bb::FrameBuffer buf_x(2, {2, 3, 3}, BB_TYPE_BIT);
    ...
    buf_x.SetBit(0, { 0, 0, 2}, 1);
    buf_x.SetBit(0, { 0, 1, 0}, 1);
    buf_x.SetBit(0, { 0, 1, 1}, 0);
    buf_x.SetBit(0, { 0, 1, 2}, 1);
    buf_x.SetBit(0, { 0, 2, 0}, 0);
    buf_x.SetBit(0, { 0, 2, 1}, 1);
    buf_x.SetBit(0, { 0, 2, 2}, 0);
    ...
    buf_x.SetBit(0, {1, 0, 2}, 0);
    buf_x.SetBit(0, {1, 1, 0}, 1);
    buf_x.SetBit(0, {1, 1, 1}, 0);
    buf_x.SetBit(0, {1, 1, 2}, 0);
    buf_x.SetBit(0, {1, 2, 0}, 1);
    buf_x.SetBit(0, {1, 2, 1}, 1);
    buf_x.SetBit(0, {1, 2, 2}, 0);
    ...
    buf_x.SetBit(1, {0, 0, 1}, 0);
    buf_x.SetBit(1, {0, 0, 2}, 1);
    buf_x.SetBit(1, {0, 1, 0}, 1);
    buf_x.SetBit(1, {0, 1, 1}, 1);
    buf_x.SetBit(1, {0, 1, 2}, 0);
    buf_x.SetBit(1, {0, 2, 0}, 0);
    buf_x.SetBit(1, {0, 2, 1}, 0);
    buf_x.SetBit(1, {0, 2, 2}, 1);
    
    // 1 1 0
    // 0 1 1
    // 0 1 0
    buf_x.SetBit(1, {1, 0, 0}, 1);
    buf_x.SetBit(1, {1, 0, 1}, 1);
    buf_x.SetBit(1, {1, 0, 2}, 0);
    buf_x.SetBit(1, {1, 1, 0}, 0);
    buf_x.SetBit(1, {1, 1, 1}, 1);
    buf_x.SetBit(1, {1, 1, 2}, 1);
    buf_x.SetBit(1, {1, 2, 0}, 0);
    buf_x.SetBit(1, {1, 2, 1}, 1);
    buf_x.SetBit(1, {1, 2, 2}, 0);
...
TEST(ConvolutionIm2ColTest, testConvolutionIm2Col_stride)
{
    ...
    bb::FrameBuffer x_buf(input_frame_size, {input_c_size, input_h_size, input_w_size}, BB_TYPE_FP32);
    ...
    EXPECT_EQ( 2,   y_buf.GetFP32(0,  { 0, 0, 2 }));
    EXPECT_EQ(10,   y_buf.GetFP32(0,  { 0, 1, 0 }));
    EXPECT_EQ(11,   y_buf.GetFP32(0,  { 0, 1, 1 }));
    EXPECT_EQ(12,   y_buf.GetFP32(0,  { 0, 1, 2 }));
    EXPECT_EQ(20,   y_buf.GetFP32(0,  { 0, 2, 0 }));
    EXPECT_EQ(21,   y_buf.GetFP32(0,  { 0, 2, 1 }));
    EXPECT_EQ(22,   y_buf.GetFP32(0,  { 0, 2, 2 }));

    EXPECT_EQ( 2,   y_buf.GetFP32(1,  { 0, 0, 0 }));
    EXPECT_EQ( 3,   y_buf.GetFP32(1,  { 0, 0, 1 }));
    EXPECT_EQ( 4,   y_buf.GetFP32(1,  { 0, 0, 2 }));
    EXPECT_EQ(12,   y_buf.GetFP32(1,  { 0, 1, 0 }));
    EXPECT_EQ(13,   y_buf.GetFP32(1,  { 0, 1, 1 }));
    EXPECT_EQ(14,   y_buf.GetFP32(1,  { 0, 1, 2 }));
    EXPECT_EQ(22,   y_buf.GetFP32(1,  { 0, 2, 0 }));
    EXPECT_EQ(23,   y_buf.GetFP32(1,  { 0, 2, 1 }));
    EXPECT_EQ(24,   y_buf.GetFP32(1,  { 0, 2, 2 }));

    EXPECT_EQ( 4,   y_buf.GetFP32(2,  { 0, 0, 0 }));
    EXPECT_EQ( 5,   y_buf.GetFP32(2,  { 0, 0, 1 }));
    EXPECT_EQ( 6,   y_buf.GetFP32(2,  { 0, 0, 2 }));
    EXPECT_EQ(14,   y_buf.GetFP32(2,  { 0, 1, 0 }));
    EXPECT_EQ(15,   y_buf.GetFP32(2,  { 0, 1, 1 }));
    EXPECT_EQ(16,   y_buf.GetFP32(2,  { 0, 1, 2 }));
    EXPECT_EQ(24,   y_buf.GetFP32(2,  { 0, 2, 0 }));
    EXPECT_EQ(25,   y_buf.GetFP32(2,  { 0, 2, 1 }));
    EXPECT_EQ(26,   y_buf.GetFP32(2,  { 0, 2, 2 }));

    EXPECT_EQ(122,  y_buf.GetFP32(4,  { 1, 0, 0 }));
    EXPECT_EQ(123,  y_buf.GetFP32(4,  { 1, 0, 1 }));
    EXPECT_EQ(124,  y_buf.GetFP32(4,  { 1, 0, 2 }));
    EXPECT_EQ(132,  y_buf.GetFP32(4,  { 1, 1, 0 }));
    EXPECT_EQ(133,  y_buf.GetFP32(4,  { 1, 1, 1 }));
    EXPECT_EQ(134,  y_buf.GetFP32(4,  { 1, 1, 2 }));
    EXPECT_EQ(142,  y_buf.GetFP32(4,  { 1, 2, 0 }));
    EXPECT_EQ(143,  y_buf.GetFP32(4,  { 1, 2, 1 }));
    EXPECT_EQ(144,  y_buf.GetFP32(4,  { 1, 2, 2 }));

    EXPECT_EQ(24,   y_buf.GetFP32(5,  { 0, 0, 0 }));
    EXPECT_EQ(25,   y_buf.GetFP32(5,  { 0, 0, 1 }));
    EXPECT_EQ(26,   y_buf.GetFP32(5,  { 0, 0, 2 }));
    EXPECT_EQ(34,   y_buf.GetFP32(5,  { 0, 1, 0 }));
    EXPECT_EQ(35,   y_buf.GetFP32(5,  { 0, 1, 1 }));
    EXPECT_EQ(36,   y_buf.GetFP32(5,  { 0, 1, 2 }));
    EXPECT_EQ(44,   y_buf.GetFP32(5,  { 0, 2, 0 }));
    EXPECT_EQ(45,   y_buf.GetFP32(5,  { 0, 2, 1 }));
    EXPECT_EQ(46,   y_buf.GetFP32(5,  { 0, 2, 2 }));

    EXPECT_EQ(1024, y_buf.GetFP32(11, { 0, 0, 0 }));
    EXPECT_EQ(1025, y_buf.GetFP32(11, { 0, 0, 1 }));
    EXPECT_EQ(1026, y_buf.GetFP32(11, { 0, 0, 2 }));
    EXPECT_EQ(1034, y_buf.GetFP32(11, { 0, 1, 0 }));
    EXPECT_EQ(1035, y_buf.GetFP32(11, { 0, 1, 1 }));
    EXPECT_EQ(1036, y_buf.GetFP32(11, { 0, 1, 2 }));
    EXPECT_EQ(1044, y_buf.GetFP32(11, { 0, 2, 0 }));
    EXPECT_EQ(1045, y_buf.GetFP32(11, { 0, 2, 1 }));
    EXPECT_EQ(1046, y_buf.GetFP32(11, { 0, 2, 2 }));

    EXPECT_EQ(1124, y_buf.GetFP32(11, { 1, 0, 0 }));
    EXPECT_EQ(1125, y_buf.GetFP32(11, { 1, 0, 1 }));
    EXPECT_EQ(1126, y_buf.GetFP32(11, { 1, 0, 2 }));
    EXPECT_EQ(1134, y_buf.GetFP32(11, { 1, 1, 0 }));
    EXPECT_EQ(1135, y_buf.GetFP32(11, { 1, 1, 1 }));
    EXPECT_EQ(1136, y_buf.GetFP32(11, { 1, 1, 2 }));
    EXPECT_EQ(1144, y_buf.GetFP32(11, { 1, 2, 0 }));
    EXPECT_EQ(1145, y_buf.GetFP32(11, { 1, 2, 1 }));
    EXPECT_EQ(1146, y_buf.GetFP32(11, { 1, 2, 2 }));


    // backward
    bb::FrameBuffer dy_buf(12, { 2, 3, 3 }, BB_TYPE_FP32);
    ...
    for (bb::index_t f = 0; f < 12; ++f) {
        for (bb::index_t c = 0; c < 2; ++c) {
            for (bb::index_t y = 0; y < 3; ++y) {
                for (bb::index_t x = 0; x < 3; ++x) {
                    dy_data[f][c][y][x] = (float)(1000 * f + 100 * c + 10 * y + x);
                    dy_buf.SetFP32(f, { c, y, x }, dy_data[f][c][y][x]);
                }
            }
        }
    }
...
TEST(ConvolutionIm2ColTest, testConvolutionIm2Col_same)
{
    ...
    bb::indices_t     input_shape({input_c_size, input_h_size, input_w_size});
    bb::indices_t     output_shape({output_c_size, output_h_size, output_w_size});

    auto cnvim2col = bb::ConvolutionIm2Col<>::Create(filter_h_size, filter_w_size, 1, 1, "same", "constant");
    ...
    for ( bb::index_t f = 0; f < input_frame_size; ++f) {
        for (bb::index_t c = 0; c < input_c_size; ++c) {
            for (bb::index_t y = 0; y < input_h_size; ++y) {
                for (bb::index_t x = 0; x < input_w_size; ++x) {
                    x_buf.SetFP32(f, { c, y, x }, (float)(1000 * f + 100 * c + 10 * y + x + 10000));
                }
            }
        }
    }
    ...
    EXPECT_EQ(    0, y_buf.GetFP32(0,  { 0, 0, 0 }));
    EXPECT_EQ(10000, y_buf.GetFP32(0,  { 0, 0, 1 }));
    ...
    EXPECT_EQ(    0, y_buf.GetFP32(11, { 1, 1, 2 }));
