        ...
        )
{
    ...
    if ( output_frame < output_frame_size ) {
        ...
        float x = x_buf[input_node * input_frame_stride + input_frame];
        ...
        )
{
    ...
    float const *output_grad_ptr = &dy_buf[c * filter_h_size * filter_w_size * output_frame_stride];
...
//      input_grad_ptr[input_node * input_frame_stride + input_frame] = grad;
        dx_buf[((c * input_h_size + y) * input_w_size + x) * input_frame_stride + input_frame] = grad;
    }
}
