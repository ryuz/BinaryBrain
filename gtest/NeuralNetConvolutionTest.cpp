...
TEST(NeuralNetConvolutionTest, testNeuralNetConvolution2)
{
	...
	EXPECT_EQ(17690, cnv.dW(0, 0, 0, 0));
	EXPECT_EQ(29702, cnv.dW(0, 1, 1, 1));
	EXPECT_EQ(26510, cnv.dW(1, 0, 2, 2));
	EXPECT_EQ(33452, cnv.dW(1, 1, 1, 0));
	EXPECT_EQ(47870, cnv.dW(1, 2, 2, 2));

	EXPECT_EQ(462, cnv.db(0));
	EXPECT_EQ(534, cnv.db(1));
