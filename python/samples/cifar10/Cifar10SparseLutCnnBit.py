...
# create layer
layer_cnv0_sl0 = bb.SparseLut6Bit.create([1152])
layer_cnv0_sl1 = bb.SparseLut6Bit.create([192])
layer_cnv0_sl2 = bb.SparseLut6Bit.create([32])
...
net.add(bb.BinaryModulationBit.create(main_net, training_modulation_size=training_modulation_size, inference_modulation_size=inference_modulation_size))
...
data_augmentation = bb.image_data_augmentation(
                        shift_x_range=0.2, shift_y_range=0.2,
                        rotation_range=5.0, flip_x_rate=0.5, scale_range=0.2, rate=0.8)

runner = bb.Runner(net, model_name, loss, metrics, optimizer, data_augmentation=data_augmentation)
