...
cnv0_sub.add(bb.StochasticLut6.create([32*6*6]))
cnv0_sub.add(bb.StochasticBatchNormalization.create())
...
cnv1_sub.add(bb.StochasticLut6.create([32*6*6]))
cnv1_sub.add(bb.StochasticBatchNormalization.create())
...
cnv2_sub.add(bb.StochasticLut6.create([64*6*6]))
cnv2_sub.add(bb.StochasticBatchNormalization.create())
...
net.add(bb.StochasticLut6.create([512*6]))
net.add(bb.StochasticBatchNormalization.create())
net.add(bb.StochasticLut6.create([512]))
net.add(bb.StochasticBatchNormalization.create())
...
runner = bb.Runner(net, "cifar10-fp32-sparse-lut-cnn", loss, metrics, optimizer)
