...
class NeuralNetInputLimitedAffineBc : public NeuralNetInputLimited<T, INDEX>
{
...
public:
	NeuralNetInputLimitedAffineBc() {}

	NeuralNetInputLimitedAffineBc(INDEX input_node_size, INDEX output_node_size, std::uint64_t seed = 1)
	{
