...
class NeuralNetLutDiscrete : public NeuralNetSparseLayer<T, INDEX>
{
...
public:
	NeuralNetLutDiscrete() {}

	NeuralNetLutDiscrete(INDEX input_node_size, INDEX output_node_size, std::uint64_t seed = 1,
	...
	std::string GetClassName(void) const { return "NeuralNetLutDiscrete"; }
