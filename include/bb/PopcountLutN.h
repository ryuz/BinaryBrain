...
class PopcountLutN : public BinaryLutModel
{
    using _super = BinaryLutModel;

public:
    static inline std::string ClassName(void) { return "PopcountLutN"; }
...
protected:
    PopcountLutN(create_t const &create)
    {
...
public:
    ...
    static std::shared_ptr<PopcountLutN> Create(create_t const &create)
    {
    ...
    static std::shared_ptr<PopcountLutN> Create(void)
    {
    ...
    static std::shared_ptr<PopcountLutN> CreatePy(
                int             n,
                indices_t       output_shape,
                std::string     connection="",
                std::uint64_t   seed = 1)
